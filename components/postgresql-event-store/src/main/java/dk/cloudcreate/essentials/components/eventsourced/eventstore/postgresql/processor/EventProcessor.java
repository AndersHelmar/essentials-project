...
public abstract class EventProcessor implements Lifecycle {
    ...
    public void resetSubscriptions(Map<AggregateType, GlobalEventOrder> resetAggregateSubscriptionsFromAndIncluding) {
        ...
        resetAggregateSubscriptionsFromAndIncluding.keySet().forEach(aggregateType -> {
            ...
            matchingSubscription.ifPresentOrElse(eventStoreSubscription -> {
                    doResetSubscription(resetAggregateSubscriptionsFromAndIncluding, aggregateType, eventStoreSubscription);
                },
                 () -> {
    ...
    private void doResetSubscription(Map<AggregateType, GlobalEventOrder> resetAggregateSubscriptionsFromAndIncluding,
